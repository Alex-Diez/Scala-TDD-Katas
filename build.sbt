...
lazy val binary_tree_day_08 = project.in(file("binary_tree_kata/binary_tree_day_08"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_08")

lazy val binary_tree_day_09 = project.in(file("binary_tree_kata/binary_tree_day_09"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_09")

lazy val binary_tree_day_10 = project.in(file("binary_tree_kata/binary_tree_day_10"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_10")

lazy val binary_tree_day_11 = project.in(file("binary_tree_kata/binary_tree_day_11"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_11")

lazy val binary_tree_day_12 = project.in(file("binary_tree_kata/binary_tree_day_12"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_12")

lazy val binary_tree_day_13 = project.in(file("binary_tree_kata/binary_tree_day_13"))
  .settings(common: _*)
  .settings(name := "binary_tree_day_13")
